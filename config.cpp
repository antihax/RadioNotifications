class CfgPatches {
	class RadioNotifications {
		requiredAddons[] = { "BitWiseFramework", "DZ_Data", "DZ_Sounds_Effects", "DZ_Gear_Books", "DZ_Scripts" };
	};
};
...
class CfgVehicles {
	...
	class Book_RadioNotificationsSIGINT : Inventory_Base {
		model = "RadioNotifications\data\book_sigint\antihax_sigint_guide_book.p3d";
		displayName = "SIGINT Guide Book";
		descriptionShort = "$STR_CfgVehicles_radionotification_sigint_book";
		title = "SIGINT Guide Book";
		weight = 1;
		author = "antihax";
		itemSize[] = { 1, 2 };
		scope = 2;
		hiddenSelectionsTextures[] = { "RadioNotifications\data\book_sigint\antihax_sigint_guide_book.paa" };
	};
};
...
class CfgDistanceFilters {
	class RadioNotification_DistantAttentionAttenuationFilter {
		type = "lowPassFilter";
...
class CfgSound3DProcessors {
	class RadioNotification_Distant3DProcessor {
		type = "panner";
		innerRange = 100;
		range = 2000;
...
class CfgSoundSets {
	...
	class RadioNotification_Alarm1 : RadioNotification_Alarm_SoundSet {
		distanceFilter = "RadioNotification_DistantAttentionAttenuationFilter";
		sound3DProcessingType = "RadioNotification_Distant3DProcessor";
