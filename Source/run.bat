...
set allclientmods=%modpath%\@CF;%modpath%\@VanillaPlusPlusMap;%modpath%\@VPPAdminTools;%modpath%\@RedFalcon Flight System Heliz;%modpath%\@Airdrop;%modpath%\@DNA_Keycards;
